...
import sty from "./PlasmicButton.module.css"; // plasmic-import: GmxXxFehucHb/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: nxp9lAUXIlwl/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: oVi7IlkiYPQC/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ik0V7)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__gmeAg)}
                role={"img"}
              />
            ),
